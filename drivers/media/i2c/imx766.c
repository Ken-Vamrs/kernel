 ...
 * Xclk 24Mhz
 * max_framerate 30fps
 * register setting from vendor 4096x3072 mode
 */
static const struct regval imx766_4096x3072p30_regs[] = {
	{0x0112, 0x0A},
	{0x0113, 0x0A},
	{0x0114, 0x03},
	{0x0202, 0x0C},
 ...
 * Xclk 24Mhz
 * max_framerate 30fps
 * register setting from vendor 3840x2160 mode
 */
static const struct regval imx766_3840x2160p30_regs[] = {
	{0x0112, 0x0A},
	{0x0113, 0x0A},
	{0x0114, 0x03},
	{0x0202, 0x08},
...
static const struct imx766_mode supported_modes[] = {
	{
		...
		.hts_def = 0x6C00,
		.vts_def = 0x0C4C,
		.reg_list = imx766_4096x3072p30_regs,
		.spd = &imx766_full_spd,
		.ebd = &imx766_full_ebd,
		.hdr_mode = NO_HDR,
		.vc[PAD0] = 0,
	},
	{
		...
		.hts_def = 0x6C00,
		.vts_def = 0x08DC,
		.reg_list = imx766_3840x2160p30_regs,
		.spd = &imx766_full_spd,
		.ebd = &imx766_full_ebd,
		.hdr_mode = NO_HDR,
		.vc[PAD0] = 0,
